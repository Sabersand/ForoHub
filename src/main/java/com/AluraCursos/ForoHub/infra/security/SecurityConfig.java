    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable()) // Deshabilitar CSRF
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST,"/topicos/registrar").permitAll()
                        .requestMatchers(HttpMethod.GET,"/topicos/listarTopicos").permitAll()
                        .requestMatchers(HttpMethod.DELETE,"/topicos/{id}").permitAll()
